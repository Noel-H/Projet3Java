...
//
//        for (int i = 0; i < playerResponseTableau.length; i++) {
//            playerResponseTableau[i] = Arrays.asList(playerResponseTableau).stream().mapToInt(Integer::parseInt).toArray();
//
//            System.out.println(playerResponseTableau[i]);
//        }
...
//        System.out.println(numberString);
//
//        int playerResultat=0115;
//
//        int resulat[]= new int[resultatScanner];
//
//        for (int i=resultatScanner-1;i>-1;i--){
//
//            resulat[i]=(playerResultat%g)/d;
//
...
//        resultat[0]=(playerResultat%10000)/1000;
//
